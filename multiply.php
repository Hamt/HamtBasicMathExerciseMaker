<html>
	<head>
		<title>Hamt - 초등곱샘 연습문제 제작기</title>
		...
		<style>
			...
			p.number.bottom{ border-bottom:2px solid black; background: url(/quiz_assets/multi.png) no-repeat left 2px;background-size:14px; padding:0px 0px 10px 0px;}
			p.answer{ color:red; }
	...
	<body>
		...
		<div id='setting' style='text-align:center;'>
			...
			<?php if(isset($_GET['save_file']) && $_GET['save_file'] == 'Y') : ?> 
				답안지 페이지 : http://hamt.kr/multiply.php?pagekey=<?=urlencode($pagekey)?>
				<br />
